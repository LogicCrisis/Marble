...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 31173 or testnet: 131173)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 31172 or testnet: 131172)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Marble Wiki for SSL setup instructions)") + "\n" +
